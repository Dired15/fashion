...
const productList=[
    {
        ...
        price:"$300",
        imageUrl1:"/handPickedBg1.jpg",
        imageUrl2:"/handPickedBg2.jpg",
    },
    {
    ...
    return (
            <div className="flex flex-row justify-between  items-center mb-20  xl:px-[5%] lg:px-[3%] md:px-[3%] px-[5%]">
                ...
                <ul className="flex flex-row justify-between ">
                    <li className=" aspect-3/4 w-[20vw] mr-10 flex flex-row justify-center items-end rounded-lg bg-[url(/bgModel1.jpg)] bg-cover bg-norepeat">
                        <button className="text-white font-medium text-normal px-8 py-3 bg-[hsl(210,9%,31%)] rounded-lg w-fit mb-10 ">Clothes</button>
                    </li>
                    <li className=" aspect-3/4 w-[20vw] mr-10 flex flex-row justify-center items-end rounded-lg bg-[url(/bgModel2.jpg)] bg-cover bg-norepeat">
                        <button className="text-white font-medium text-normal px-8 py-3 bg-[hsl(210,9%,31%)] rounded-lg w-fit mb-10 ">Dress</button>
                    </li>
                    <li className=" aspect-3/4 w-[20vw] flex flex-row justify-center items-end rounded-lg bg-[url(/bgModel3.jpg)] bg-cover bg-norepeat">
                        <button className="text-white font-medium text-normal px-8 py-3 bg-[hsl(210,9%,31%)] rounded-lg w-fit mb-10 ">Pants</button>
                    </li>
                </ul>
            </div>
           );
...
function ProductElement(props){
    ...
    const divStyle1=`w-full h-full absolute bg-[url(${props.imageUrl1})] hover:hidden bg-cover bg-norepeat bg-center z-10`;
    const divStyle2=`w-full h-full absolute bg-[url(${props.imageUrl2})] bg-cover bg-norepeat bg-center z-5`;
    ...
    return (
        <li className="flex flex-col justify-end w-[15vw] ">
            <div>
                ...
                <h3 className="text-center font-medium text-lg mb-2">{props.productName}</h3>
