...
function ServiceAdvantageList(props){
    ...
    return (
            ...
            <div className="flex flex-row justify-between overflow-x-auto   xl:px-[5%] mb-20 ">
                    <div className="flex flex-row advantageCard flex-none   xl:w-[20vw] lg:w-[25vw] w-[60vw] mr-8  ">      
                    ...
                    <div className="flex flex-row advantageCard  flex-none  xl:w-[20vw] lg:w-[25vw] w-[60vw]  ">
    ...
    return (
            <div className="flex md:flex-row md:justify-between flex-col  md:items-center mb-20  xl:px-[5%] lg:px-[3%] md:px-[3%] px-[5%]">
                <div className="flex flex-col justify-between xl:w-[22%] lg:w-[27%] md:w-[35%] h-fit md:mb-0 mb-10 ">
                    ...
                    <p className="  md:mb-6 mb-4 w-[80vw]">A never-ending rush, trendy combinations, cool steps. Check out the indispensable pieces of urban style.</p>
