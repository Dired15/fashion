    ...
    return (
        <div className=" py-24 bg-black  text-white">
            <div className="flex md:flex-row md:justify-between flex-col  items-center mb-20  xl:px-[5%] lg:px-[3%] md:px-[3%] px-[5%]">
                ...
                <div className="flex-none relative md:w-auto w-full ">
                    <button className="xl:hidden absolute aspect-square rotate-180 md:w-[5vw] w-[10vw] -left-4 rounded-full z-100  top-[45%]  bg-[hsl(210,9%,31%)]">
                        <div className="aspect-square w-full  bg-[url(/arrowIcon.png)] bg-cover bg-no-repeat  delimtiationRed"></div>
                    </button>
                    <button className=" xl:hidden absolute aspect-square  md:w-[5vw] w-[10vw] -right-4 rounded-full  z-100 top-[45%]  bg-[hsl(210,9%,31%)]">
                        <div className="aspect-square w-full  bg-[url(/arrowIcon.png)] bg-cover bg-no-repeat  delimtiationRed"></div>
                    </button>
