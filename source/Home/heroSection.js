...
export default function HeroSection(props)
{
    return (
        <div className="  xl:aspect-16/6 md:aspect-16/7 aspect-4/5 flex flex-col justify-center  bg-[url(/heroBg3.jpg)]  bg-center bg-cover bg-no-repeat   bg-black">
            <div className="w-full h-full flex flex-col justify-center md:bg-[hsla(0,0%,0%,0.3)] bg-[hsla(0,0%,0%,0.4)] xl:px-[5%] lg:px-[3%] md:px-[3%] px-[5%]">
                ...
                <div className=" xl:w-1/2 lg:w-[80%] md:w-[80%] w-full ">
                    ...
                    <p className="text-white text-normal text-lg mb-8 md:w-[70%]">Dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia.</p>
